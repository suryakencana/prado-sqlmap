<?php namespace System\Data\SqlMap\Configuration;
/**
...
use System\Data\SqlMap\Statements\TStaticSql;
use System\Data\SqlMap\Statements\TSimpleDynamicSql;
use System\Data\SqlMap\Statements\TMappedStatement;
use System\Data\SqlMap\Statements\TInsertMappedStatement;
use System\Data\SqlMap\Statements\TDeleteMappedStatement;
use System\Data\SqlMap\Statements\TUpdateMappedStatement;
use System\Data\SqlMap\Statements\TSelectMappedStatement;
...
class TSqlMapXmlMappingConfiguration extends TSqlMapXmlConfigBuilder
{
	...
	public function configure($filename)
	{
		...
		if($bCacheDependencies === null)
			$bCacheDependencies = 'development';//Prado::getApplication()->getMode() !== TApplicationMode::Performance;
