<?php namespace System\Data\Common;
/**
...
use System\Data\Common\Mysql\TMysqlMetaData;
use System\Data\Common\Mysql\TMysqlTableInfo;
/**
...
//				return new TIbmDb2MetaData($conn);
	...
	public function getTableInfo($tableName=null)
	{
		...
		if(!isset($this->_tableInfoCache[$key]))
		{
			...
			var_dump($class);
			$tableInfo = $tableName===null ? new TMysqlTableInfo() : $this->createTableInfo($tableName);
